    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        {items.map((item) => (
          <div
            key={item.id}
            className="flex items-center gap-3 py-3 border-b border-border last:border-b-0 animate-fade-in"
          >
            {/* Veg/Non-Veg Icon */}
            <div
            ...
            <div className="flex items-center bg-swiggy-green rounded overflow-hidden">
              <button
                ...
                className="p-1.5 hover:bg-swiggy-green/80 transition-colors"
              >
      ...
      <div className="border-t border-border p-4 bg-secondary/30">
        ...
        <div className="space-y-2 text-sm">
          ...
          <div className="flex justify-between">
            ...
            <span className={deliveryFee === 0 ? "text-swiggy-green" : "text-foreground"}>
      ...
      <div className="p-4 border-t border-border">
        <Button className="w-full bg-swiggy-green hover:bg-swiggy-green/90 text-white font-bold py-6">
          Proceed to Checkout
