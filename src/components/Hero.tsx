    ...
    <section className="relative bg-gradient-to-br from-primary via-primary to-primary/90 overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-12 sm:py-20 relative">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="bg-card rounded-2xl p-2 swiggy-shadow animate-fade-in" style={{
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              <div className="flex-1 flex items-center gap-2 px-4 py-3 bg-secondary rounded-xl">
                ...
                <input 
                  type="text" 
                  placeholder="Enter delivery location (e.g. Melvisharam)" 
              ...
              <button 
                ...
                className="flex items-center justify-center gap-2 px-6 py-3 bg-primary text-primary-foreground rounded-xl font-semibold hover:bg-primary/90 transition-colors"
              >
          ...
          {/* Popular Locations */}
          <div className="flex flex-wrap justify-center gap-2 mt-4 animate-fade-in" style={{ animationDelay: "300ms" }}>
            {["Melvisharam", "Chennai", "Vellore", "Ranipet"].map((loc) => (
              <button
                key={loc}
